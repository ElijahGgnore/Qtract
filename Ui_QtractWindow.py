...
class Ui_QtractWindow(object):
    ...
    def retranslateUi(self, QtractWindow):
        ...
        self.label_2.setText(_translate("QtractWindow", "<html><head/><body><p>Left mouse click — select words</p><p>Left mouse drag — rubber band select words</p><p>Ctrl + left click / drag — add to the current selection</p><p>Ctrl + A — select all words</p><p>Alt A / left click on the background — deselect all words</p><p>Ctrl + C — copy selected words</p></body></html>"))
